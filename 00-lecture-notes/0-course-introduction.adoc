...
- Exercise sets and final project, done during the first 15 weeks.
    ...
    - Divided into three *parts*: two exercise sets and a final project.
...
- First-part - development of *frontends* for browser-based applications.
- Second-part - development of *backends* for Web-based systems.
